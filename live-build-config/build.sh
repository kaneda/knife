...
TARGET_DIR=$(dirname $0)/images/knife-$KALI_VERSION
SUDO="sudo"
VERBOSE=""
...
for KALI_ARCH in $KALI_ARCHES; do
	...
	mv $IMAGE_NAME $TARGET_DIR/knife-linux-$KALI_VERSION-$KALI_ARCH.$IMAGE_EXT
	mv build.log $TARGET_DIR/knife-linux-$KALI_VERSION-$KALI_ARCH.log
done
